...
* NEW CODE
        SELECT mwskz
        UP TO 1 ROWS  INTO lv_mwskz
        FROM ekpo
        WHERE ebeln EQ p_data-folioref ORDER BY PRIMARY KEY.
...
* NEW CODE
  ...
  UP TO 1 ROWS 
    INTO lv_lifnr
    FROM lfa1
   WHERE stcd1 EQ p_data-rutemisor ORDER BY PRIMARY KEY.
...
* NEW CODE
      ...
      UP TO 1 ROWS 
       ...
       WHERE ebeln EQ wa_hes_oc2-folio
         AND vgabe EQ '9'
         AND belnr EQ wa_hes_oc-folio ORDER BY PRIMARY KEY.
