...
* NEW CODE
          SELECT *
          UP TO 1 ROWS  FROM   zfich002 WHERE estado = zfich001-estado
                                          AND   bukrs = zfich001-bukrs ORDER BY PRIMARY KEY.
...
* NEW CODE
            SELECT *
            UP TO 1 ROWS  FROM bseg WHERE bukrs = zjdatos_edocheq-bukrs
                                      AND   belnr =  numero
                                      AND   gjahr =  zjdatos_edocheq-fecha+0(4)
...
* NEW CODE
          SELECT *
          UP TO 1 ROWS  FROM payr WHERE zbukr = zjdatos_edocheq-bukrs
                                    AND   hbkid = zjdatos_edocheq-hbkid
                                    AND   hktid = zjdatos_edocheq-hktid
                                    AND   rzawe = 'C'
                                    AND   chect = zjdatos_edocheq-chect ORDER BY PRIMARY KEY.
