...
*&
*&---------------------------------------------------------------------*
*&Rescata Tabla ANEA Original Respaldada
*&
*&---------------------------------------------------------------------*
...
data : begin of t_texto occurs 0,
       ...
       begin of t_ANEA occurs 0.
        include structure ANEA.
data :    box   type c,
       end of t_ANEA,
       err_ANEA like ANEA occurs 0 with header line,
       ERROR    TYPE C.
* Variables ALV
TYPE-POOLS slis.
...
FORM user_command USING r_ucomm     LIKE sy-ucomm
  ...
  case r_ucomm.
    when 'FC01'.
      refresh err_ANEA.
      LOOP AT T_ANEA WHERE BOX EQ 'X'.
        MOVE SY-TABIX TO L_TABIX.
        move-corresponding t_ANEA to ANEA.
*
* PGR CARGA EN AREA ALTERNATIVA
        IF NOT P_AF_ALT IS INITIAL.
          move P_AF_ALT to anea-afabe.
        ENDIF.
***********************************
*        insert ANEA.
* PGR
        ...
        MODIFY ANEA.
        if sy-subrc ne 0.
          append ANEA to err_ANEA.
        endif.
        T_ANEA-BOX = ' '.
        MODIFY T_ANEA INDEX L_TABIX.
      ENDLOOP.
      IF SY-SUBRC NE 0.
...
*    ls_line-info = 'Datos de tabla ANEA Respaldados'.
*  ELSE.
*    ls_line-info = 'Datos con ERROR de tabla ANEA Respaldados'.
*  ENDIF.
...
***********************************
    ...
    MODIFY ANEA.
    if sy-subrc ne 0.
      write:/ 'Error al Grabar' , ANEA-anln1, ANEA-anln2.
    endif.
  ENDLOOP.
*
