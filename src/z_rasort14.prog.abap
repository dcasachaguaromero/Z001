...
* NEW CODE
  ...
  UP TO 1 ROWS  FROM T001
    WHERE BUKRS EQ ANLAV-BUKRS ORDER BY PRIMARY KEY.
...
* NEW CODE
    SELECT *
    UP TO 1 ROWS  FROM T090U
      WHERE SPRAS  EQ SY-LANGU
      AND   SIMVAR EQ *ANLA0-SIMVAR ORDER BY PRIMARY KEY.
...
*   ... und Ersetzungsvorschriften aus T090I ...
    REFRESH X090I.
*ResQ Comment:Correction not required as Order By already present is used 19/12/2019 EY_DES03 ECDK917080 *
