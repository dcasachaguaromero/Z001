...
REPORT  ZFIINFACREDORES no standard page heading.
...
initialization.
    ...
    SELECT-OPTIONS:
          S_BUKRS FOR  LFB1-BUKRS  NO-EXTENSION
                                   NO INTERVALS,
...
FORM OBTENER_DATOS.
  ...
  SELECT b~BUKRS b~LIFNR b~AKONT
  INTO   T_DATOS
...
FORM top_of_page_setup.
  ...
  wa_header-typ  = 'H'.
  wa_header-info = 'LISTADO DE ACREEDORES'.
