...
WHERE BUKRS EQ T_DATOS-BUKRS
  AND BELNR EQ T_DATOS-BELNR
  AND GJAHR EQ T_DATOS-GJAHR
  AND (  MWSKZ EQ 'C4' OR MWSKZ EQ 'C6' )  ORDER BY PRIMARY KEY.
...
WHERE BUKRS EQ T_DATOS-BUKRS
  AND BELNR EQ T_DATOS-BELNR
  AND GJAHR EQ T_DATOS-GJAHR
  AND (  MWSKZ EQ 'C5' OR MWSKZ EQ 'C9' )  ORDER BY PRIMARY KEY.
...
WHERE BUKRS EQ T_DATOS-BUKRS
  AND BELNR EQ T_DATOS-BELNR
  AND GJAHR EQ T_DATOS-GJAHR ORDER BY PRIMARY KEY.
...
WHERE  BUKRS EQ T_DATOS-BUKRS
  AND  BELNR EQ T_DATOS-BELNR
  AND  GJAHR EQ T_DATOS-GJAHR
  AND  HWSTE NE 0 ORDER BY PRIMARY KEY.
...
WHERE  BUKRS EQ T_DATOS-BUKRS
  AND  BELNR EQ T_DATOS-BELNR
  AND  GJAHR EQ T_DATOS-GJAHR
  AND  HWSTE EQ 0 ORDER BY PRIMARY KEY.
...
* NEW CODE
  ...
  FROM   M_KREDK
WHERE BUKRS EQ T_DATOS-BUKRS
  AND LIFNR EQ T_DATOS-LIFNR ORDER BY PRIMARY KEY.
