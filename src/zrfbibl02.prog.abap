...
FORM FILL_FTPOST_WITH_BBSEG_DATA USING COUNT.
  ...
  IF BBSEG-XREF2(1)                    NE NODATA.
    ...
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-ZZPRESTAC(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
      FTPOST-FNAM = 'COBL-ZZPRESTAC                      '.
    ELSE.
      FTPOST-FNAM = 'BSEG-ZZPRESTAC                      '.
    ENDIF.
    FTPOST-FVAL = BBSEG-ZZPRESTAC                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-ZZUNID_PRO(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
      FTPOST-FNAM = 'COBL-ZZUNID_PRO                     '.
    ELSE.
      FTPOST-FNAM = 'BSEG-ZZUNID_PRO                     '.
    ENDIF.
    FTPOST-FVAL = BBSEG-ZZUNID_PRO                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-ZZDESC_EST(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
      FTPOST-FNAM = 'COBL-ZZDESC_EST                     '.
    ELSE.
      FTPOST-FNAM = 'BSEG-ZZDESC_EST                     '.
    ENDIF.
    FTPOST-FVAL = BBSEG-ZZDESC_EST                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-ZZMOT_EMIS(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
      FTPOST-FNAM = 'COBL-ZZMOT_EMIS                     '.
    ELSE.
      FTPOST-FNAM = 'BSEG-ZZMOT_EMIS                     '.
    ENDIF.
    FTPOST-FVAL = BBSEG-ZZMOT_EMIS                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-ZZRUT_TERC(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
      FTPOST-FNAM = 'COBL-ZZRUT_TERC                     '.
    ELSE.
      FTPOST-FNAM = 'BSEG-ZZRUT_TERC                     '.
    ENDIF.
    FTPOST-FVAL = BBSEG-ZZRUT_TERC                 .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-ZZ_AGENCIA(1)               NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    IF XTBSL-KOART = 'S' OR XTBSL-KOART = 'A'.
      FTPOST-FNAM = 'COBL-ZZ_AGENCIA                     '.
    ELSE.
      FTPOST-FNAM = 'BSEG-ZZ_AGENCIA                     '.
    ENDIF.
    FTPOST-FVAL = BBSEG-ZZ_AGENCIA                 .
    APPEND FTPOST.
  ENDIF.
  ...
  IF BBSEG-RKE_PPRCTR(1)               NE NODATA.
    ...
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_BESKZ(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_BESKZ                      '.
    FTPOST-FVAL = BBSEG-RKE_BESKZ                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KUNRE(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KUNRE                      '.
    FTPOST-FVAL = BBSEG-RKE_KUNRE                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_KUNWE(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_KUNWE                      '.
    FTPOST-FVAL = BBSEG-RKE_KUNWE                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_PAPH1(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_PAPH1                      '.
    FTPOST-FVAL = BBSEG-RKE_PAPH1                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_PAPH2(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_PAPH2                      '.
    FTPOST-FVAL = BBSEG-RKE_PAPH2                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_PAPH3(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_PAPH3                      '.
    FTPOST-FVAL = BBSEG-RKE_PAPH3                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_PSTYV(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_PSTYV                      '.
    FTPOST-FVAL = BBSEG-RKE_PSTYV                  .
    APPEND FTPOST.
  ENDIF.
  IF BBSEG-RKE_WWCST(1)                NE NODATA.
    CLEAR: FTPOST-FNAM, FTPOST-FVAL.
    FTPOST-FNAM = 'BSEG-RKE_WWCST                      '.
    FTPOST-FVAL = BBSEG-RKE_WWCST                  .
    APPEND FTPOST.
  ENDIF.
