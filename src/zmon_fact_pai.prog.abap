...
* NEW CODE
      SELECT *
 INTO LS_DETPEDEXT FROM ZDETPEDEXT WHERE ZNUM_DOC_CORE EQ GT_CABPEDEXT-ZNUM_DOC_CORE ORDER BY PRIMARY KEY.
...
* NEW CODE
          SELECT *
          UP TO 1 ROWS  FROM ZCABPEDEXT WHERE ZNUM_DOC_CORE EQ GT_CABPEDEXT-ZNUM_DOC_CORE ORDER BY PRIMARY KEY.
...
* NEW CODE
        SELECT KUNNR
        UP TO 1 ROWS  INTO GT_CABPEDEXT-ZRUT_CLI_PAGADOR FROM KNA1 WHERE STCD1 EQ ZCABPEDEXT-ZRUT_CLI_PAGADOR ORDER BY PRIMARY KEY.
...
* NEW CODE
        SELECT KUNNR
        UP TO 1 ROWS  INTO GT_CABPEDEXT-ZRUT_CLI_FACT    FROM KNA1 WHERE STCD1 EQ ZCABPEDEXT-ZRUT_CLI_FACT ORDER BY PRIMARY KEY.
