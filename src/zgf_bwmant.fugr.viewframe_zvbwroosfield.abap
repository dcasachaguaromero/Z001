*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVBWROOSFIELD
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVBWROOSFIELD       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVBWROOSFIELD'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVBWROOSFIELD_EXTRACT
TOTAL = ZVBWROOSFIELD_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVBWROOSFIELD'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVBWROOSFIELD-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVBWROOSFIELD_EXTRACT
TOTAL = ZVBWROOSFIELD_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVBWROOSFIELD-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVBWROOSFIELD'
...
TOTAL = ZVBWROOSFIELD_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVBWROOSFIELD-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVBWROOSFIELD-UPD_FLAG NE SPACE.
