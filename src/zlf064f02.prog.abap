...
* NEW CODE
  ...
  ENDSELECT.
* END. 07-07-2026 - ATC - ATC-01"ALRK240194
...
* NEW CODE
    SELECT BEGRU
    UP TO 1 ROWS   INTO BEGRU  FROM SKB1
           WHERE  BUKRS       = BUKRS
           AND    SAKNR       = HKONT           ORDER BY PRIMARY KEY.
...
* NEW CODE
    ...
    UP TO 1 ROWS  FROM T001
      WHERE BUKRS = XBSEG-BUKRS ORDER BY PRIMARY KEY.
...
* NEW CODE
    ...
    UP TO 1 ROWS 
      INTO (KNB1_BUFFER-BEGRA, KNB1_BUFFER-NAME1)
      FROM KNA1
      WHERE KUNNR = KUNNR ORDER BY PRIMARY KEY.
...
* NEW CODE
    ...
    UP TO 1 ROWS 
      ...
      FROM KNB1
      WHERE BUKRS = BUKRS
        AND KUNNR = KUNNR ORDER BY PRIMARY KEY.
...
* NEW CODE
    ...
    UP TO 1 ROWS 
      INTO (LFB1_BUFFER-BEGRA, LFB1_BUFFER-NAME1)
      FROM LFA1
      WHERE LIFNR = LIFNR ORDER BY PRIMARY KEY.
...
* NEW CODE
    ...
    UP TO 1 ROWS 
      ...
      FROM LFB1
      WHERE BUKRS = BUKRS
        AND LIFNR = LIFNR ORDER BY PRIMARY KEY.
