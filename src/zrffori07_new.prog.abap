  ...
  IF REGUH-PAYGR+18(2) EQ '$J'.        "Bankgebühr (nur Japan)
    ...
    if sy-langu <> 'J'.
      ...
      WRITE:/       SY-VLINE NO-GAP,
          ...
          (10)    REGUH-PAYGR,         "Belegnummer Bankgebühr
          48      TXT_BEGLEITL,
          110  REGUH-RSPE1 CURRENCY T001-WAERS,
          132     SY-VLINE.
    endif.
...
FORM ABSCHLUSS_BANKLEITZAHL.
  ...
  IF FLG_BANKINFO EQ 2.
    ...
    if sy-langu <> 'J'.
      ...
      WRITE: 110 REGUD-SUMME+4,          "Betrag in Hauswährung
             132 SY-VLINE.
    endif.
    ULINE.
  ENDIF.
...
* NEW CODE
      ...
      UP TO 1 ROWS  FROM TCURC
        WHERE WAERS EQ HLP_WAERS ORDER BY PRIMARY KEY.
...
* END. 07-07-2026 - ATC - ATC-01
  ...
  if sy-langu <> 'J'.
    ...
    WRITE: 110 REGUD-SUMME+4,            "Zwischensumme in Hauswährung
           132 SY-VLINE.
  endif.
