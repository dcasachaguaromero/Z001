...
*        WHERE opvar = it_fields-value.                      
*
* NEW CODE
        SELECT opvar
        UP TO 1 ROWS  FROM t010o INTO ld_opvar        "2635046
        WHERE opvar = it_fields-value ORDER BY PRIMARY KEY.                      

        ENDSELECT.
* END. 07-07-2026 - ATC - ATC-01"2635046
