...
* NEW CODE
  SELECT formname
  UP TO 1 ROWS  FROM stxfadm INTO h_formname
  WHERE formname = lf_formname ORDER BY PRIMARY KEY.
...
* NEW CODE
  SELECT *
  UP TO 1 ROWS  FROM t024e WHERE ekorg EQ viqmel-ekorg ORDER BY PRIMARY KEY.
...
* NEW CODE
  SELECT *
  UP TO 1 ROWS  FROM t001 WHERE bukrs EQ t024e-bukrs ORDER BY PRIMARY KEY.
...
* NEW CODE
    SELECT *
    UP TO 1 ROWS  FROM lfa1 WHERE
          lifnr = viqmel-lifnum ORDER BY PRIMARY KEY.
