...
FORM fill_header  CHANGING t_download TYPE ty_t_download.
  ...
  ls_download-data+137(16) = 'Saldo Acom.'.
  APPEND ls_download TO t_download .CLEAR ls_download.
...
FORM fill_file USING t_outtab       TYPE  ty_t_outtab
  ...
  DATA: ls_outtab TYPE ty_s_outtab,
        ...
        l_hkont TYPE hkont,
        l_saldo_s TYPE dmbtr,
        l_saldo_e TYPE dmbtr,
        l_debe  TYPE dmbtr,
        l_haber TYPE dmbtr,
        l_num TYPE i,
        l_mod TYPE i.
  ...
  LOOP AT t_outtab  INTO ls_outtab .
    ...
    IF l_hkont NE ls_outtab-hkont(10).
      ...
      IF g_num GT 1.
        ...
        WRITE l_saldo_s    TO ls_download-data+119(13) CURRENCY ls_outtab-waers.
        WRITE l_saldo_e    TO ls_download-data+136(13) CURRENCY ls_outtab-waers.

        WRITE l_debe       TO ls_download-data+85(13)  CURRENCY ls_outtab-waers.
        WRITE l_haber      TO ls_download-data+102(13) CURRENCY ls_outtab-waers.
        APPEND ls_download TO t_download .CLEAR ls_download.
        ls_download-data = c_line.
        APPEND ls_download TO t_download .CLEAR ls_download.
      ...
      PERFORM get_description_hkont2
                  USING
                     ls_outtab-hkont
                  CHANGING
                     ls_download-data+17(20).


      ls_download-data+3(10)  = ls_outtab-hkont.
      WRITE ls_outtab-saldo_end TO ls_download-data+136(13) CURRENCY 'CLP'.
      APPEND ls_download TO t_download .CLEAR ls_download.
      ls_download-data = c_line.
      APPEND ls_download TO t_download .CLEAR ls_download.
    ...
    ELSE.
      ...
      WRITE ls_outtab-dmbtr_s     TO ls_download-data+85(13)  CURRENCY ls_outtab-waers.
      WRITE ls_outtab-dmbtr_h     TO ls_download-data+102(13) CURRENCY ls_outtab-waers.
      WRITE ls_outtab-saldo_start TO ls_download-data+119(13) CURRENCY ls_outtab-waers.
      WRITE ls_outtab-saldo_end   TO ls_download-data+136(13) CURRENCY ls_outtab-waers.
      APPEND ls_download TO t_download .
      CLEAR ls_download.
...
FORM fill_total USING t_tabtot TYPE ty_t_tabtot
  ...
  LOOP AT t_tabtot INTO ls_tabtot.
    ...
    WRITE ls_tabtot-dmbtr_s TO ls_download-data+127(13) CURRENCY ls_tabtot-waers.
    WRITE ls_tabtot-dmbtr_h TO ls_download-data+144(13) CURRENCY ls_tabtot-waers.
    APPEND ls_download TO t_download .CLEAR ls_download.
  ENDLOOP.
  ...
  WRITE dmbtr_s TO ls_download-data+127(15) CURRENCY ls_tabtot-waers.
  WRITE  dmbtr_h TO ls_download-data+144(15) CURRENCY ls_tabtot-waers.
  APPEND ls_download TO t_download .CLEAR ls_download.
  ls_download-data+106(41) = c_line_2.
  APPEND ls_download TO t_download .CLEAR ls_download.
ENDFORM.                    " fill_total
...
FORM fill_total2 USING t_tabtot TYPE ty_t_tabtot
  ...
  DATA: ls_download TYPE ty_s_download,
        ls_tabtot   TYPE ty_s_tabtot.
  DATA:  L_dmbtr_s TYPE dmbtr.
  DATA:  L_dmbtr_H TYPE dmbtr.
...
*    ls_download-data+109(2)  = ls_tabtot-blart.
  ...
  WRITE L_dmbtr_s TO ls_download-data+83(15) CURRENCY ls_tabtot-waers.
  WRITE L_dmbtr_h TO ls_download-data+100(15) CURRENCY ls_tabtot-waers.
  WRITE G_saldo_s1 TO ls_download-data+117(15) CURRENCY ls_tabtot-waers.
  WRITE G_saldo_e1 TO ls_download-data+134(15) CURRENCY ls_tabtot-waers.
  APPEND ls_download TO t_download .CLEAR ls_download.
...
FORM get_saldos .
  ...
  LOOP AT gt_outtab INTO ls_outtab.
    ...
    IF l_hkont NE ls_outtab-hkont(10).
      ...
      CLEAR g_saldo_s.
      G_saldo_s1 = G_saldo_s1 + ls_outtab-SALDO_START.
      G_saldo_e1 = G_saldo_e1 + ls_outtab-SALDO_END.
    ENDIF.
