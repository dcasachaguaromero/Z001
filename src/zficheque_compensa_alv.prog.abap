*&---------------------------------------------------------------------*
*&  Include           ZFI_CHEQUE_COMPENSA_ALV
*&---------------------------------------------------------------------*
*&---------------------------------------------------------------------*
...
FORM f_user_command USING pe_ucomm     LIKE sy-ucomm
  ...
  CASE pe_ucomm.
    WHEN '&IC1'."Hotpost
      ...
      IF pe_selfield-fieldname EQ 'DOC_COMP' AND w_datos-doc_comp IS NOT INITIAL.
        SET PARAMETER ID 'BLN' FIELD w_datos-doc_comp.
        SET PARAMETER ID 'BUK' FIELD w_datos-bukrs.
        SET PARAMETER ID 'GJR' FIELD sy-datum+1(4).
