  ...
  LOOP AT t_outtab  INTO ls_outtab .
    ...
    IF l_hkont NE ls_outtab-hkont(10).
      ...
      IF g_num GT 1.
        ...
        WRITE l_saldo_s    TO ls_download-data+116(16) CURRENCY ls_outtab-waers.
        WRITE l_saldo_e    TO ls_download-data+133(16) CURRENCY ls_outtab-waers.

        WRITE l_debe       TO ls_download-data+82(16)  CURRENCY ls_outtab-waers.
        WRITE l_haber      TO ls_download-data+99(16) CURRENCY ls_outtab-waers.
        APPEND ls_download TO t_download .CLEAR ls_download.
        ls_download-data = c_line.
        APPEND ls_download TO t_download .CLEAR ls_download.
        ADD 3 TO l_linea.
    ...
    ELSE.
      ...
      l_saldo_s =  ls_outtab-saldo_start.
      l_saldo_e =  ls_outtab-saldo_end.
      WRITE ls_outtab-dmbtr_s     TO ls_download-data+82(16)  CURRENCY ls_outtab-waers.
      WRITE ls_outtab-dmbtr_h     TO ls_download-data+99(16) CURRENCY ls_outtab-waers.
      WRITE ls_outtab-saldo_start TO ls_download-data+116(16) CURRENCY ls_outtab-waers.
      WRITE ls_outtab-saldo_end   TO ls_download-data+133(16) CURRENCY ls_outtab-waers.
      APPEND ls_download TO t_download .
      CLEAR ls_download.
...
*    ls_download-data+109(2)  = ls_tabtot-blart.
  ...
  WRITE L_dmbtr_s TO ls_download-data+79(18) CURRENCY ls_tabtot-waers.
  WRITE L_dmbtr_h TO ls_download-data+98(18) CURRENCY ls_tabtot-waers.
  WRITE G_saldo_s1 TO ls_download-data+115(17) CURRENCY ls_tabtot-waers.
  WRITE G_saldo_e1 TO ls_download-data+132(17) CURRENCY ls_tabtot-waers.
  APPEND ls_download TO t_download .CLEAR ls_download.
