*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_T042
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_T042             .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_T042'
         EXPORTING
              FCODE          = READ
...
CALL FUNCTION 'VIEWPROC_ZV_T042'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_T042-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_T042_EXTRACT
TOTAL = ZV_T042_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_T042-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_T042'
...
TOTAL = ZV_T042_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_T042-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_T042-UPD_FLAG NE SPACE.
