...
DATA : gt_bkpf1  TYPE TABLE OF bkpf,
       gt_bkpf2  TYPE TABLE OF bkpf,
       gv_bkpf1  TYPE cursor,
       gv_bkpf2  TYPE cursor,
       gv_flag_1 TYPE abap_bool,
       gv_flag_2 TYPE abap_bool,
       r_budat1  TYPE RANGE OF bkpf-budat,
       r_budat2  TYPE RANGE OF bkpf-budat,
       lr_budat  LIKE LINE OF r_budat1,
       gv_tabix  TYPE i,
       gv_proc   Type i,
       gv_maxlin TYPE i       VALUE 200000.
