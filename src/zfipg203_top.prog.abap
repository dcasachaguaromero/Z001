...
DATA : BEGIN OF int_tabla  OCCURS 1.
        INCLUDE STRUCTURE zfipg203_est.
...
DATA : BEGIN OF int_tabla1  OCCURS 1.
        INCLUDE STRUCTURE zfipg203_a_est.
...
DATA:       nfirma2(70) TYPE c,
            ...
            pass2(25)  TYPE c,
            v_DETALLE TYPE ZTIPODETALLE. "ZMOT_PAG-DETALLE_NOMINA.
*          v_DETALLE TYPE ZMOT_PAG-DETALLE_NOMINA.
