...
data:   ibukrs type bkpf-bukrs,  "Sociedad
        ...
        ihbkid type skb1-hbkid,            "Banco Propio
        ihktid type skb1-hktid,            "Id.Cuenta
        igjahr type bkpf-gjahr,            "Ejercicio
        icpudt type bkpf-cpudt,            "Fecha creacion registro
        icputm type bkpf-cputm,            "Hora creacion registro
        ibschl type bseg-bschl,            "clave de contabilizacion
        iestche type c.                 "Estado de Cheque
...
loop at s_bukrs.
  try.
    exec sql.
          execute procedure csc_sap.sp_elimina_sap_anadoc(
                            in :s_bukrs-low,
                            in :p_fecini,
                            in :p_fecfin)
    endexec.
...
bschl "Clave de contabilizacion
into (izuonr,ihkont,iprctr,isgtxt,izzprestac,izzunid_pro,izzdesc_est,izzmot_emis,izzrut_terc,izz_agencia,ishkzg,idmbtr,ibschl)
from bseg
...
* END. 07-07-2026 - ATC - ATC-01
      ...
      iestche = ''. "Estado de cheque se define por query en la tabla
      ...
      try.
        ...
        vvalor = ivalor.
        concatenate texto it_bkpf-bukrs
        it_bkpf-belnr
        it_bkpf-budat
        it_bkpf-xblnr
        izuonr
        ...
        iestche
        ibschl
        sy-mandt into texto separated by ','.
        write texto.
        LEAVE PROGRAM.
      endtry.
