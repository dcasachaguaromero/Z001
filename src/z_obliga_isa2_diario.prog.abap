...
REPORT Z_OBLIGA_ISA2_DIARIO message-id 26 line-size 255
no standard page heading.

* Z_OBLIGA_ISA2_DIARIO.
...
CONSTANTS C_DF_VK(40) VALUE '485'.
...
INTO CORRESPONDING FIELDS OF LFA1
FROM LFA1
WHERE ( LIFNR = ITAB3-LIFNR ) ORDER BY PRIMARY KEY.
...
WHERE ( ( VBLNR = ITAB3-AUGBL )
 AND ( ( LIFNR = ITAB3-LIFNR )
 AND ( ( GJAHR = ITAB3-GJAHR )
 AND ( ZBUKR = ITAB3-BUKRS ) ) ) ) ORDER BY PRIMARY KEY.
