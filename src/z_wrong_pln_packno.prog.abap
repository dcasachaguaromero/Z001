...
* NEW CODE
SELECT *
UP TO 1 ROWS  FROM essr INTO w_essr
                WHERE lblni = nr_lblni ORDER BY PRIMARY KEY.
...
* NEW CODE
  SELECT *
 FROM ml_esll INTO w_ml_esll
            WHERE hpackno = w_essr-packno
              AND packno NE w_essr-packno ORDER BY PRIMARY KEY.
...
* NEW CODE
  SELECT *
  UP TO 1 ROWS  FROM ekpo WHERE ebeln = w_essr-ebeln
                             AND  ebelp = w_essr-ebelp ORDER BY PRIMARY KEY.
...
* NEW CODE
 ...
 FROM ml_esll INTO w_ml_esll
            WHERE hpackno = ekpo-packno
              AND packno NE ekpo-packno ORDER BY PRIMARY KEY.
