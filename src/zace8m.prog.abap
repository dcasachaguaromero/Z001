...
*
DATA: REPREL(10) TYPE C VALUE '8.10.304'.
*
*            ===============================================
*         =====================================================
*      ===========================================================
...
PARAMETERS: CDSDATE TYPE D DEFAULT '20140701'.
SELECTION-SCREEN END OF LINE.
  ...
  IF ( ALL_CL3 = 'X' OR ALL_CL3 = 'x' ).
    SELECT
     ...
     PACKAGE SIZE 1000
             FROM USR04
                  CLIENT SPECIFIED
            WHERE MODDA >= CDSDATE."#EC CI_BUFFCLIENT
  ...
  SELECT        CMDSTRING
     ...
     PACKAGE SIZE 1000
          ...
          WHERE SYDATE >= CDSDATE
            AND RETCODE = '0000'
            AND CMDSTRING like 'IMPORT%'."#EC CI_NOFIRST
**add comment
...
*        PERFORM ADDB0007 USING ZEILE.
  ...
  PERFORM ADDB3 USING 'PROGNAME' 80 '' '' '' '' 'Program' 'Program' ''.
