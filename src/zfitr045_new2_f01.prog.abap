...
*Begin V1_MJD- Vales vista abonos agrupados Santander
check p_agrstd is initial. "Si está marcado deja un solo correlativo en la tabla para estos casos.
*End V1_MJD-- Vales vista abonos agrupados Santander
...
*Begin  Problemas REGUH 07-03-2025 V1-CNN
  DATA lt_tpro LIKE tpro OCCURS 0 WITH HEADER LINE.
*End Problemas REGUH 07-03-2025 V1-CNN
*
  CLEAR gt_salida[].
*
...
*->   BEG MOD V1-CNNN 23.06.2022 ECDK922463
...
** V1 RVY FIN 26.10.2023
      ...
      ENDIF.
*->   END MOD V1-CNNN 23.06.2022 ECDK922463
...
*Begin  Problemas REGUH 07-03-2025 CN
*    APPEND tpro.
    lt_tpro = tpro.
    APPEND lt_tpro.
*End  Problemas REGUH 07-03-2025 CN
