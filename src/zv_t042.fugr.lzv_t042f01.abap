...
* NEW CODE
  SELECT *
  UP TO 1 ROWS  FROM  t001 INTO *t001 WHERE bukrs = bukrs ORDER BY PRIMARY KEY.
...
* NEW CODE
    SELECT *
 FROM t042 WHERE (vim_wheretab)  ORDER BY PRIMARY KEY.
...
* NEW CODE
      SELECT *
      UP TO 1 ROWS  FROM t001 WHERE bukrs = t042-zbukr  ORDER BY PRIMARY KEY.
