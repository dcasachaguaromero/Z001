...
*  lv_string = TI_CONT_DET-ATRIBUTO_8+3(37).
...
*        ENDIF.
        ...
        ENDIF.
*        ACCOUNTTAX-DIRECT_TAX     = 'X'."SBERNARDI 23.01.2020
        APPEND accounttax.
        CLEAR: accounttax.
      ENDIF.
    WHEN 'AP'.
...
*        SELECT single BVTYP into ACCOUNTPAYABLE-PARTNER_BK
*          from lfbk
*          where lifnr = TI_CONT_DET-VENDOR_NO
*            and bankl = TI_CONT_DET-ATRIBUTO_8+0(3)
*            and bankn = lv_bankn
*              .
      ...
      "fin mod Seidor Crystalis 10.12.2013
...
* INI 10-02-2020 manejo de RETENCION HCD
...
* FIN 10-02-2020 manejo de RETENCION HCD
        APPEND accountwt.
        CLEAR: accountwt.
      ENDIF.
    WHEN 'AR'.
