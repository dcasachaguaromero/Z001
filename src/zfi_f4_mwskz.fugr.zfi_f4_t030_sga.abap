...
* NEW CODE
  SELECT *
  UP TO 1 ROWS  FROM T030B WHERE KTOSL = 'SWE' ORDER BY PRIMARY KEY.
...
* NEW CODE
  SELECT *
 FROM T074U
         WHERE UMSKS NE 'A' ORDER BY PRIMARY KEY.
...
* NEW CODE
    SELECT *
    UP TO 1 ROWS  FROM T074T WHERE SPRAS = SY-LANGU
                               AND   KOART = T074U-KOART
                               AND   SHBKZ = T074U-UMSKZ ORDER BY PRIMARY KEY.
