...
*Begin Mario Jofré- Vales vista abonos agrupados Santander
SELECTION-SCREEN SKIP.
PARAMETERS : p_agrstd AS CHECKBOX.
*end Mario Jofré- Vales vista abonos agrupados Santander
SELECTION-SCREEN END OF BLOCK b1.

INITIALIZATION.
  MOVE sy-tcode TO gv_tcode.
  IF gv_tcode NE 'ZFITR045_NEW_2'.
    gv_tcode = 'ZFITR045_NEW_2'.
  ENDIF.

  AUTHORITY-CHECK OBJECT 'S_TCODE'
  ID 'TCD' FIELD gv_tcode.
  IF sy-subrc NE 0.
    MESSAGE e077(s#) WITH gv_tcode.
  ENDIF.
...
*
*  IF bukrs <> 'CL03'.
*    MESSAGE e004(zfi) WITH 'Esta transaccion solo permite procesar' 'la sociedad CL03'.
*  ENDIF.
...
*Begin Mario Jofré- Vales vista abonos agrupados Santander
CASE screen-name.
      WHEN 'P_AGRSTD'. "p_agrstd
        IF sy-tcode NE 'ZFITR045_NEW_2'.
          screen-active = 0.
        ENDIF.
    ENDCASE.
*End Mario Jofré- Vales vista abonos agrupados Santander
