...
*---------------------------------------------------------------------*
FORM GET_FORM_TITLE
USING    IS_NAST       TYPE NAST
IS_EKKO       TYPE EKKO
IV_LANGUAGE   TYPE DDLANGUAGE
IS_DRUVO      TYPE DRUVO
CHANGING CV_FORM_TITLE TYPE DRTYP .


* BEGIN. 07-07-2026 - ATC - ATC-01
* OLD CODE
*SELECT SINGLE DRTYP FROM T166U
*INTO CV_FORM_TITLE
