...
*  size is in bytes; e.g. 100000000 = 100mb
  p_cb_max_zip_size TYPE i VALUE 2277376,
...
* Loop over tables
  LOOP AT it_tables INTO mytab.
    ...
    wa_header-leng        = 'Länge'. "#EC NOTEXT
    wa_header-intlen      = 'Int. Länge (Bytes)'. "#EC NOTEXT
    wa_header-outputlen   = 'Ausgabelänge'. "#EC NOTEXT
    ...
    wa_header-keyflag     = 'Schlüsselfeld'. "#EC NOTEXT
...
* Leerzeile für kompatibilität mit älteren ACL Versionen
  MyLine = ''.
  TRANSFER myline TO filename.
