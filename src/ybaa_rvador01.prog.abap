*----------------------------------------------------------------------*
*              Print of an order confirmation by Smart Form
*----------------------------------------------------------------------*
REPORT YBAA_RVADOR01 LINE-COUNT 100 MESSAGE-ID vn.
...
*     ACHTUNG: FKREL im RMCSSU08 mitpflegen !!!!
      con_fkrel_liefer(5)             VALUE 'AHJKM',
      con_fkrel_liefermenge(6)        VALUE 'AGHJKM',
...
CONSTANTS :   objtype_vbrl LIKE nast-objtype VALUE 'VBRL'.
*-----------------------------------------------------------------------
*       Branchenschalter
*-----------------------------------------------------------------------
...
* NEW CODE
  SELECT *
  UP TO 1 ROWS  FROM tvko  WHERE vkorg = vbdka-vkorg ORDER BY PRIMARY KEY.
