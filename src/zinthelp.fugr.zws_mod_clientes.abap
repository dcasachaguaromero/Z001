...
* NEW CODE
  SELECT *
  UP TO 1 ROWS  FROM KNA1 WHERE STCD1 EQ WA_DATA-RUT ORDER BY PRIMARY KEY.
...
* NEW CODE
    SELECT *
    UP TO 1 ROWS  FROM ADR2 WHERE ADDRNUMBER EQ KNA1-ADRNR
                                AND R3_USER    EQ SPACE ORDER BY PRIMARY KEY.
