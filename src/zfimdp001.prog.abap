...
*&
*&---------------------------------------------------------------------*
PROGRAM  zfimdp001 MESSAGE-ID z001.
...
** Modificado por L_FOUBERT 30.05.2013 Definicion de variables 'Time'
DATA: GV_SECOND TYPE I.
DATA  seconds   type int1.
** END L_FOUBERT 30.05.2013 Definicion de variable 'Time'
...
** Modificado por LFOUBERT 03.06.2013 Definicion de Datos.
INCLUDE ZFIMDP001_TOP.
** END L_FOUBERT 03.06.2013 Definicion de Datos.
...
*&---------------------------------------------------------------------*
*&      Module  TCC_MODIFY_SECONDS  INPUT
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
module TCC_MODIFY_SECONDS input.

*  IF SECONDS IS INITIAL.
**gv_second = SECONDS.
*    SECONDS = 3.
*  ENDIF.
endmodule.                 " TCC_MODIFY_SECONDS  INPUT

INCLUDE zfimdp005_inc.

INCLUDE zfimdp004_new.
