...
DATA : BEGIN OF reg_stder OCCURS 0,
           ...
           cuenta_abono(18)    TYPE C ,"cuenta_abono(18)    TYPE n , mod. 25.11.2013 cambio de num a char. Seidor Crystalis.
...
* Se ajusta Rut a la Izquierda.
  ...
  "mod 25.11.2013 agrega 0 adelante del string Seidor Crystalis
  SHIFT reg_stder-cuenta_abono RIGHT deleting trailing space.
  translate reg_stder-cuenta_abono using ' 0'.
*  WRITE : reg_stder-cuenta_abono.
  "fin mod
...
top-of-page.
  WRITE : /1  t001-BUTXT,
           43   'NOMINA DE PAGO PROVEEDORES CUENTA BANCO SANTANDER' ,
           120 sy-datum,
