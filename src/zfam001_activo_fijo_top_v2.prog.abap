...
TABLES: anlz,    "Asignaciones de activos fijos con fecha valor
        ...
        t091c,   "Métodos de conversión en la contab. de inmovilizados
        t093b.   "Datos área valoración específicos de sociedad
...
DATA:
  ...
  wa_cont_ceco   TYPE i,
  wa_existe(1)   TYPE n,
  wa_eliminar(1) TYPE c,
  wa_flag(1)     TYPE c,
  wa_tabix       TYPE sy-tabix,
  WA_AWKEY       LIKE BKPF-AWKEY,
  wa_mes_cierre  TYPE c,
  wa_periodo(6)     TYPE n,
  wa_per_cierre(6)  TYPE n,
...
DATA:
      ...
      UMVAR      LIKE T091C-umvar,
      CON_LEITBE LIKE anep-afabe VALUE '01'.
...
DATA begin of lt_anla occurs 1.
        include structure anla.
DATA end   of lt_anla.

DATA begin of it_t095 occurs 1.
        include structure t095.
DATA end   of it_t095.
DATA begin of it_ANKT occurs 1.
        include structure ANKT.
DATA end   of it_ANKT.


DATA begin of it_movtos occurs 1.
...
* ANLC
            ...
            INVER_INIC_EJE     LIKE anlc-knafa,   "Depreciacion Acumulada Inicio Ejerc
            INVER_ACUM_EJE     LIKE anlc-knafa,   "Depreciacion Acumulada Ejerc
            ...
            dep_bajas          LIKE anlc-knafa,
            dep_trasl          LIKE anlc-knafa,
            dep_espec          LIKE anlc-knafa,
            dep_no_plan        LIKE anlc-knafa,

            rev_amor_inic_eje  LIKE anlc-knafa,
            rev_amor_acum_eje  LIKE anlc-knafa,
            rev_amor_mes_eje   LIKE anlc-knafa,

            amort_acum_eje     LIKE anlc-knafa,
...
*Formulacion CSC
            VALOR_INIC_EJE_CSC  LIKE anlc-knafa,
            MONTO_BRUTO_CSC     LIKE anlc-knafa,
            Dep_Inic_Eje_CSC    LIKE anlc-knafa,
            Dep_Acum_CSC        LIKE anlc-knafa,
            MONTO_NETO_CSC      LIKE anlc-knafa,

*Formulacion CSC 02.12.2011
            DEP_INIC_EJE_2      LIKE anlc-knafa,
            AMONOR_INIC_EJE_2   LIKE anlc-knafa,
            AMOESP_INIC_EJE_2   LIKE anlc-knafa,
            AMONPL_INIC_EJE_2   LIKE anlc-knafa,
