...
* NEW CODE
  SELECT *
  UP TO 1 ROWS  FROM t086
    WHERE srtvar EQ srtvr ORDER BY PRIMARY KEY.
...
* NEW CODE
    SELECT *
    UP TO 1 ROWS  FROM t093t
      WHERE spras  EQ sy-langu
      AND   afapl  EQ t093c-afapl
      AND   afaber EQ akl_afabe ORDER BY PRIMARY KEY.
...
* NEW CODE
  SELECT *
 FROM  t160b
         WHERE  tcode       = 'AW01' ORDER BY PRIMARY KEY.
