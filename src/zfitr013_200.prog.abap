...
* END. 07-07-2026 - ATC - ATC-01
    ...
    SELECT  * FROM  regup WHERE laufd = reguh-laufd
                          ...
                          AND   kunnr = reguh-kunnr
                          AND   empfg = reguh-empfg
*Begin of change: ReSQ Correction for Addition ORDER BY PRIMARY KEY 27/12/2019 EY_DES01 ECDK916994*
*                          AND   vblnr = reguh-vblnr.
                          AND   vblnr = reguh-vblnr ORDER BY PRIMARY KEY.
*End of change: ReSQ Correction for Addition ORDER BY PRIMARY KEY 27/12/2019 EY_DES01 ECDK916994*
