...
* NEW CODE
      SELECT *
      UP TO 1 ROWS  FROM anla WHERE bukrs = p_bukrs
                                AND   anln1 = anln1_bus
                                AND   anln2 = anln2_bus ORDER BY PRIMARY KEY.
...
* NEW CODE
          SELECT *
          UP TO 1 ROWS  FROM anlb WHERE bukrs = p_bukrs
                                AND   anln1 = anln1_bus
                                AND   anln2 = anln2_bus
                                AND   afabe = p_afabe1
                                AND   bdatu = '99991231' ORDER BY PRIMARY KEY.
...
* NEW CODE
            SELECT *
            UP TO 1 ROWS  FROM anlc WHERE bukrs = p_bukrs
                                    AND   anln1 = anln1_bus
                                    AND   anln2 = anln2_bus
                                    AND   gjahr = p_gjahr
                                    AND   afabe = p_afabe1 ORDER BY PRIMARY KEY.
