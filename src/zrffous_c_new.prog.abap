...
* NEW CODE
    ...
    UP TO 1 ROWS 
     ...
     WHERE zbukr EQ zw_zbukr-low
       AND hbkid EQ sel_hbki-low
       AND hktid EQ sel_hkti-low
       AND formulario EQ par_zfor ORDER BY PRIMARY KEY.
...
*----------------------------------------------------------------------*
  INCLUDE zrffori07_new.

*----------------------------------------------------------------------*
*  international subroutines                                           *
*----------------------------------------------------------------------*
  INCLUDE zrffori99_new.

*----------------------------------------------------------------------*
*  rutinas z                                                           *
*----------------------------------------------------------------------*
  INCLUDE zrffous_c_f_for_caratula_new.

  INCLUDE zrffous_c_f_for_voucherf01_new.

  INCLUDE zrffous_c_f_for_cheque_new.
