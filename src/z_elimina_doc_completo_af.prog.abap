...
* NEW CODE
 ...
 from v_anepk
  APPENDING CORRESPONDING FIELDS OF table XANEK
                  ...
                  AND   TCODE IN S_TCODE
                  AND   CPUDT IN S_CPUDT
                  AND   USNAM IN S_USNAM ORDER BY PRIMARY KEY.
...
* NEW CODE
    SELECT *
    UP TO 1 ROWS  FROM ANEP WHERE BUKRS = XANEK-BUKRS
                               AND   ANLN1 = XANEK-ANLN1
                               AND   ANLN2 = XANEK-ANLN2
                               AND   GJAHR = XANEK-GJAHR
                               AND   LNRAN = XANEK-LNRAN
                               AND   AFABE NOT IN S_AFABE ORDER BY PRIMARY KEY.
...
* NEW CODE
      SELECT *
      UP TO 1 ROWS  FROM ANLH WHERE BUKRS = WANEK-BUKRS
                                AND   ANLN1 = WANEK-ANLN1 ORDER BY PRIMARY KEY.
