*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFI_OB52_MAIL
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFI_OB52_MAIL      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFI_OB52_MAIL'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFI_OB52_MAIL_EXTRACT
TOTAL = ZVFI_OB52_MAIL_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFI_OB52_MAIL'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFI_OB52_MAIL-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFI_OB52_MAIL_EXTRACT
TOTAL = ZVFI_OB52_MAIL_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFI_OB52_MAIL-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFI_OB52_MAIL'
...
TOTAL = ZVFI_OB52_MAIL_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFI_OB52_MAIL-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFI_OB52_MAIL-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVFI_OB52_MAIL'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVFI_OB52_MAIL-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFI_OB52_MAIL_EXTRACT
TOTAL = ZVFI_OB52_MAIL_TOTAL
