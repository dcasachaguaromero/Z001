*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFI_REGUH
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFI_REGUH          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFI_REGUH'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFI_REGUH_EXTRACT
TOTAL = ZVFI_REGUH_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFI_REGUH'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFI_REGUH-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFI_REGUH_EXTRACT
TOTAL = ZVFI_REGUH_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFI_REGUH-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFI_REGUH'
...
TOTAL = ZVFI_REGUH_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFI_REGUH-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFI_REGUH-UPD_FLAG NE SPACE.
