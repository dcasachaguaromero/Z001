...
*Eliminamos caracteres especiales.
          WHILE regud-znm1s CS 'Ñ'.
            REPLACE 'Ñ' WITH 'N' INTO regud-znm1s.
          ENDWHILE.
          ...
          WHILE regud-znm2s CS 'Ñ'.
            REPLACE 'Ñ' WITH 'N' INTO regud-znm2s.
          ENDWHILE.
...
*--------------------------------------------------
*          A
          WHILE spell-word CS 'Á'.
            REPLACE 'Á' WITH 'A' INTO spell-word.
          ENDWHILE.
...
*           E
          WHILE spell-word CS 'É'.
            REPLACE 'É' WITH 'E' INTO spell-word.
          ENDWHILE.
...
*           I
          WHILE spell-word CS 'Í'.
            REPLACE 'Í' WITH 'I' INTO spell-word.
          ENDWHILE.
...
*          O
          WHILE spell-word CS 'Ó'.
            REPLACE 'Ó' WITH 'o' INTO spell-word.
          ENDWHILE.
...
*          U
          WHILE spell-word CS 'Ú'.
            REPLACE 'Ú' WITH 'U' INTO spell-word.
          ENDWHILE.
