...
* NEW CODE
 ...
 FROM febep CLIENT SPECIFIED
          WHERE mandt = WA_FEBKO-MANDT
                AND KUKEY = WA_FEBKO-KUKEY
                AND esnum NOT IN s_esnum ORDER BY PRIMARY KEY.
...
* NEW CODE
          SELECT *
 FROM febep CLIENT SPECIFIED INTO TABLE it_febep
          WHERE mandt = WA_FEBKO-MANDT
                AND KUKEY = WA_FEBKO-KUKEY
...
* NEW CODE
          SELECT *
 FROM febre CLIENT SPECIFIED INTO TABLE it_febre
          WHERE mandt = WA_FEBKO-MANDT
                AND KUKEY = WA_FEBKO-KUKEY
                AND esnum IN s_esnum ORDER BY PRIMARY KEY.
...
* NEW CODE
          SELECT *
 FROM febcl CLIENT SPECIFIED INTO TABLE it_febcl
          WHERE mandt = WA_FEBKO-MANDT
                AND KUKEY = WA_FEBKO-KUKEY
                AND esnum IN s_esnum ORDER BY PRIMARY KEY.
