...
* END. 07-07-2026 - ATC - ATC-03
  ...
  if wa_contador > 0 AND wa_batch = 'N'.
* BEGIN. 07-07-2026 - ATC - ATC-03
* OLD CODE
*     SELECT * FROM bkpf
...
* NEW CODE
 ...
 FROM bkpf
           ...
           WHERE BUKRS  EQ it_bsis-BUKRS
           AND   BELNR  EQ it_bsis-BELNR
           AND   GJAHR  EQ it_bsis-GJAHR ORDER BY PRIMARY KEY.
...
AND GJAHR EQ IT_BKPF-GJAHR ORDER BY PRIMARY KEY.
...
* NEW CODE
 ...
 FROM FEBEP
             INTO CORRESPONDING FIELDS OF TABLE it_FEBEP
             FOR ALL ENTRIES IN it_febko
             WHERE KUKEY  EQ it_febko-KUKEY ORDER BY PRIMARY KEY.
...
* END. 07-07-2026 - ATC - ATC-03
  ...
  SORT it_febep    BY GJAHR BUDAT AK1BL.
  SORT it_skb1     BY BUKRS SAKNR.


***>>> LBERNAL 22.08.2011 >>>
* Asigno campos de cabecera contable
  loop at it_bkpf.

      CLEAR: it_febep-TEXTS,
             it_febep-CHECT,
             it_febko-AZNUM.

      READ TABLE it_febep WITH KEY GJAHR = it_bkpf-GJAHR
                                   BUDAT = it_bkpf-BUDAT
                                   AK1BL = it_bkpf-BELNR
                                   BINARY SEARCH.
      if sy-subrc = 0.
      ...
      loop at it_bsis WHERE BUKRS = it_bkpf-BUKRS
          ...
          READ TABLE it_skb1 WITH KEY BUKRS = it_bkpf-BUKRS
                                      SAKNR = it_bsis-HKONT
                                      BINARY SEARCH.
          if sy-subrc = 0.
...
* NEW CODE
 ...
 FROM bkpf
           ...
           WHERE BUKRS  EQ it_bsas-BUKRS
           AND   BELNR  EQ it_bsas-BELNR
           AND   GJAHR  EQ it_bsas-GJAHR ORDER BY PRIMARY KEY.
...
* Adiciono las partidas Abiertas
...
* Asigno campos de cabecera contable
  loop at it_bkpf.
      ...
      loop at it_bsas WHERE BUKRS = it_bkpf-BUKRS
                        AND GJAHR = it_bkpf-GJAHR
                        AND BELNR = it_bkpf-BELNR.
          ...
          IF it_bsas-BLART in S_BLART.
              it_bsas-SISTEMA = 'SAP_BANCO'.
              it_bsas-USUARIO =  it_bsas-USNAM.
              it_bsas-Movto   = 'B'.
          ELSE.
              it_bsas-SISTEMA = 'SAP_CONTABILIDAD'.
              it_bsas-USUARIO =  it_bsas-USNAM.
              it_bsas-Movto   = 'C'.
          ENDIF.
...
*----------------------------------------------------------------------*
  ...
  LOOP AT it_bsas WHERE BUKRS  = wa_BUKRS
                    AND HKONT  = wa_HKONT.
* PYV 16/11/2011 *

*    clear it_detalle.
*    MOVE-CORRESPONDING it_bsas TO it_detalle.
...
*    APPEND it_Detalle.
    ...
    clear it_detalle.
    if it_bsas-augdt gt p_budat or it_bsas-augdt is initial.
      MOVE-CORRESPONDING it_bsas TO it_detalle.
      if it_detalle-SHKZG = 'H'.
         it_detalle-MONTO = it_detalle-DMBTR * -1.
      else.
...
*----------------------------------------------------------------------*
  ...
  IF wa_hkont is initial.
     IF P_OPEN = 'X'.
        wa_titulo = 'Detalle Conciliación Bancaria (partidas abiertas)'.
        LOOP AT it_bsis WHERE BUKRS  = P_BUKRS
                        AND ESTADO = 'A'.
          clear it_detalle.
    ...
    ELSE.
        wa_titulo = 'Detalle Conciliación Bancaria (todas)'.
        LOOP AT it_bsas WHERE BUKRS  = P_BUKRS.
          clear it_detalle.
* PYV 22/11/2011  Se agrega if
          if it_bsas-augdt gt p_budat or it_bsas-augdt is initial.
           MOVE-CORRESPONDING it_bsas TO it_detalle.
           if it_detalle-SHKZG = 'H'.
              it_detalle-MONTO = it_detalle-DMBTR * -1.
...
*----------------------------------------------------------------------*
  ...
  SORT it_bsis BY BUKRS HKONT SISTEMA USUARIO.

  LOOP AT it_bsis WHERE BUKRS   = wa_BUKRS
                    AND HKONT   = wa_HKONT
                    AND SISTEMA = wa_SISTE
                    AND USUARIO = wa_usuar
                    AND ESTADO  = 'A'.
...
FORM ASIGNAR_CAMPOS .
  PERFORM f_asigna_fieldcat USING:
    ...
    'HBKID'      'IT_DETALLE' ' ' ' '  '03' ' ' ' ' 'Banco'  ' ' ' ' ' ' '5',
    'GJAHR'      'IT_DETALLE' ' ' ' '  '04' ' ' ' ' 'Ejerc'  ' ' ' ' ' ' '5',
    'BELNR'      'IT_DETALLE' ' ' ' '  '05' ' ' ' ' 'N°Compr' ' ' ' ' ' ' '10',
    'BUZEI'      'IT_DETALLE' ' ' ' '  '06' ' ' ' ' 'Po' ' ' ' ' ' ' '3',
    'BUDAT'      'IT_DETALLE' ' ' ' '  '07' ' ' ' ' 'Fec_Contab' ' ' ' ' ' ' '10',
    'WAERS'      'IT_DETALLE' ' ' ' '  '08' ' ' ' ' 'Moneda'  ' ' ' ' ' ' '5',
    'XBLNR'      'IT_DETALLE' ' ' ' '  '09' ' ' ' ' 'Referencia' ' ' ' ' ' ' '16',
    'BLART'      'IT_DETALLE' ' ' ' '  '10' ' ' ' ' 'TD' ' ' ' ' ' ' '2',
    'BSCHL'      'IT_DETALLE' ' ' ' '  '11' ' ' ' ' 'Cl'  ' ' ' ' ' ' '2',
    'MONTO'      'IT_DETALLE' ' ' ' '  '12' ' ' ' ' 'Monto'  ' ' ' ' ' ' '35',
    'SGTXT'      'IT_DETALLE' ' ' ' '  '13' ' ' ' ' 'TextoExplicativo'  ' ' ' ' ' ' '30',
    'ZUONR'      'IT_DETALLE' ' ' ' '  '14' ' ' ' ' 'N°Asignac'  ' ' ' ' ' ' '18',
    'AWKEY'      'IT_DETALLE' ' ' ' '  '15' ' ' ' ' 'ClaveRef'  ' ' ' ' ' ' '20',
    'USNAM'      'IT_DETALLE' ' ' ' '  '16' ' ' ' ' 'Usuario' ' ' ' ' ' ' '12',
    'AUGDT'      'IT_DETALLE' ' ' ' '  '17' ' ' ' ' 'FecComp'  ' ' ' ' ' ' '10',
    'AUGBL'      'IT_DETALLE' ' ' ' '  '18' ' ' ' ' 'DocComp'  ' ' ' ' ' ' '10',
    'STBLG'      'IT_DETALLE' ' ' ' '  '19' ' ' ' ' 'Nro_Doc_Anul'      ' ' ' ' ' ' '20',
    'STJAH'      'IT_DETALLE' ' ' ' '  '20' ' ' ' ' 'Ejerc_Doc_Anul'      ' ' ' ' ' ' '10',
    'STGRD'      'IT_DETALLE' ' ' ' '  '21' ' ' ' ' 'Motivo_Anul'      ' ' ' ' ' ' '10',
    'XREF1_HD'   'IT_DETALLE' ' ' ' '  '22' ' ' ' ' 'ClRefC1' ' ' ' ' ' ' '20',
    'XREF2_HD'   'IT_DETALLE' ' ' ' '  '23' ' ' ' ' 'ClRefC2' ' ' ' ' ' ' '20',
    'AZNUM'      'IT_DETALLE' ' ' ' '  '24' ' ' ' ' 'Extracto' ' ' ' ' ' ' '5',
    'TEXTS'      'IT_DETALLE' ' ' ' '  '25' ' ' ' ' 'Texto'      ' ' ' ' ' ' '4',
    'CHECT'      'IT_DETALLE' ' ' ' '  '26' ' ' ' ' 'N°Ch'      ' ' ' ' ' ' '13',
    'ZZMOT_EMIS' 'IT_DETALLE' ' ' ' '  '27' ' ' ' ' 'MotivoEmis'      ' ' ' ' ' ' '10'.
