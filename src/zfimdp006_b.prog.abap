...
* Validacion de acreedor
    ...
    IF sy-subrc <> 0.
      MESSAGE e776.
    ELSE.
*     LSC 17.10.2011 - Prime Group
*     Busca nombre de Proveedor
* BEGIN. 07-07-2026 - ATC - ATC-01
* OLD CODE
*      SELECT SINGLE name1 INTO zinvfo-sgtxt
*        FROM lfa1
*       WHERE lifnr = zinvfo-lifnr.
*
* NEW CODE
      SELECT name1
      UP TO 1 ROWS  INTO zinvfo-sgtxt
        FROM lfa1
       WHERE lifnr = zinvfo-lifnr ORDER BY PRIMARY KEY.
