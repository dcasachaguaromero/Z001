...
* NEW CODE
 ...
 FROM lfa1 CLIENT SPECIFIED
               UP TO 1 ROWS
        WHERE     mandt EQ sy-mandt
              AND lifnr = payr-lifnr ORDER BY PRIMARY KEY.
...
* BEGIN. 07-07-2026 - ATC - ATC-03
* OLD CODE
*        SELECT zz_agencia INTO t_ok-zagencia
...
*          SUBMIT rfbibl00 WITH ds_name  = juego_datos
        SUBMIT zrfbibl00_v2 WITH ds_name  = juego_datos
...
*PYV
  CONCATENATE '/tmp/' juego_datos INTO juego_datos."JOROZCO 18.02.2020
