...
*End of change: ReSQ Correction for MODIFY on an unsorted Internal Table 24/12/2019 EY_DES02 ECDK917080 *
  MODIFY int_tabla2 FROM zfitr045_est_002  INDEX tabla3-current_line
     TRANSPORTING sel.

ENDMODULE.                    "valida-grilla_0250 INPUT
*----------------------------------------------------------------------*
...
*ReSQ: No Need Of Change Internal Table INT_TABLA2 Already Sorted
  READ TABLE int_tabla2 INTO zfitr045_est_002 INDEX tabla3-current_line.
