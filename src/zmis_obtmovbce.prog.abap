...
loop at s_bukrs.
  try.
    exec sql.
      execute procedure csc_sap_mis.sp_elimina_sap_balance(
                        in :s_bukrs-low,
                        in :p_fecini,
                        in :p_fecfin)
    endexec.
...
* END. 07-07-2026 - ATC - ATC-01
      ...
      try.
        exec sql.
          execute procedure csc_sap_mis.sp_insert_sap_balance(
                            in :it_bkpf-bukrs,
                            in :it_bkpf-belnr,
                            in :it_bkpf-budat,
                            in :it_bkpf-xblnr,
