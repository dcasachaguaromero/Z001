...
EXEC SQL.
   EXECUTE PROCEDURE aux_sap_cheques.SP_DELETE_TES_DOCPAGO_SAP ( IN :status )
  ENDEXEC.
...
*        and ( XMANU = 'X' or XBANC = 'X' or VOIDR ne 0 )
*        and RWBTR ne 0
...
SELECT *
 from payr
  where zbukr in s_zbukr
        and ( XMANU = 'X' or XBANC = 'X' or VOIDR ne 0 )
        and RWBTR ne 0
        and laufd in s_laufd ORDER BY PRIMARY KEY.
...
*  it_spins-pind_proceso
  try.
      ...
      EXEC SQL.
        EXECUTE PROCEDURE aux_sap_cheques.SP_INSERT_TES_DOCPAGO_SAP(
                                                                    IN :IT_spins-EMPRESA  ,
                                                                    IN :IT_spins-NUMERO   ,
                                                                    IN :IT_spins-vTipo             ,
                                                                    IN :IT_spins-cuenta,
