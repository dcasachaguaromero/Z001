...
* NEW CODE
    ...
    UP TO 1 ROWS 
      FROM zmot_emis
      WHERE cta_cadf = wa_salida_bsak-hkont ORDER BY PRIMARY KEY.
...
* NEW CODE
    ...
    UP TO 1 ROWS 
    FROM zmot_emis
    WHERE cta_cade = wa_salida_bsak-hkont ORDER BY PRIMARY KEY.
...
* NEW CODE
    ...
    UP TO 1 ROWS 
    FROM zmot_emis
    WHERE cta_pres_h = wa_salida_bsak-hkont ORDER BY PRIMARY KEY.
...
* NEW CODE
    ...
    UP TO 1 ROWS 
    FROM zmot_emis
    WHERE cta_cadvv = wa_salida_bsak-hkont ORDER BY PRIMARY KEY.
