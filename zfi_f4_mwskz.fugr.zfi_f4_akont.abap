...
* NEW CODE
  ...
  UP TO 1 ROWS  FROM T001
         WHERE BUKRS = I_BUKRS ORDER BY PRIMARY KEY.
...
* NEW CODE
 ...
 FROM SKB1
             WHERE BUKRS = I_BUKRS
             AND   SAKNR LIKE I_AKONT
             AND   MITKZ = I_MITKZ ORDER BY PRIMARY KEY.
...
* NEW CODE
 ...
 FROM SKB1
             WHERE ( BUKRS = I_BUKRS
               ...
               OR  ( BUKRS = I_BUKRS
               AND   SAKNR LIKE I_AKONT
               AND   MITKZ = 'K' ) ORDER BY PRIMARY KEY.
...
* NEW CODE
 ...
 FROM SKB1
             WHERE ( BUKRS = I_BUKRS AND  MITKZ = 'D' )
                OR ( BUKRS = I_BUKRS AND  MITKZ = 'K' ) ORDER BY PRIMARY KEY.
