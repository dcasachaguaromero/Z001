...
** V1 INI RVY 04.08.23
    IF wa_file CS '.XLS'.
       CALL METHOD OBJ_MTCASH->M_PROCESA_BCI_XLS
        EXPORTING
            WI_BNCO = W_BNCO
        IMPORTING
            ITO_C = IT_C
...
*       CALL METHOD OBJ_MTCASH->M_PROCESA_BBVA
        CALL METHOD OBJ_MTCASH->M_PROCESA_BBVA_NEW
        EXPORTING
            WI_BNCO = W_BNCO
          IMPORTING
            ITO_C = IT_C
    ...
    WHEN W_ITAU.
      IF wa_file CS '.XLS'.
        ...
        EXPORTING
          WI_FILE = P_FILE
          WI_TIPO = P_TIPO.
        CALL METHOD OBJ_MTCASH->M_PROCESA_ITAU_XLS
        EXPORTING
            WI_BNCO = W_BNCO
          IMPORTING
            ITO_C = IT_C
...
*** V1 RVY 29-09-2021
    WHEN W_ESTADO.
** V! RVY INI 24.08.2023
      CALL METHOD OBJ_MTCASH->M_PROCESA_ESTADO_NEW
           EXPORTING
               WI_BNCO = W_BNCO
           IMPORTING
               ITO_C = IT_C
      ...
      if wa_file cs '.XLS'.
        ...
        EXPORTING
          ...
          IMPORTING
            ...
            ITO_D = IT_D
            .
      ELSEIF wa_file cs '.TXT'.
        CALL METHOD OBJ_MTCASH->M_PROCESA_BICE_TXT
        EXPORTING
          WI_BNCO = W_BNCO
          IMPORTING
            ITO_C = IT_C
