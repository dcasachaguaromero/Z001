...
REPORT Z_DI_LIBRO_DIARIO message-id 26 line-size 255
...
DATA ALTMP11(25) TYPE C.
DATA ALTMP12(5) TYPE C.
DATA ALTMP13(20) TYPE C.
...
ALTMP26 = BSEG-ZZRUT_TERC.
 ...
 move ALTMP9 to ITAB3-XBLNR.
 move ALTMP10 to ITAB3-STBLG.
 move ALTMP11 to ITAB3-BKTXT.
 move ALTMP12 to ITAB3-WAERS.
 move ALTMP13 to ITAB3-XREF1_HD.
 move ALTMP14 to ITAB3-XREF2_HD.
 move ALTMP15 to ITAB3-LDGRP.
 move ALTMP16 to ITAB3-BUZEI.
 move ALTMP17 to ITAB3-KOART.
 move ALTMP18 to ITAB3-SHKZG.
 move ALTMP19 to ITAB3-DMBTR.
 move ALTMP20 to ITAB3-VALUT.
 move ALTMP21 to ITAB3-ZUONR.
 move ALTMP22 to ITAB3-SGTXT.
 move ALTMP23 to ITAB3-HKONT.
 move ALTMP24 to ITAB3-KUNNR.
 move ALTMP25 to ITAB3-LIFNR.
