...
* NEW CODE
 ...
 INTO TABLE t_bkpf
        FROM bkpf WHERE bukrs IN s_bukrs AND
                        ...
                        bldat IN s_bldat AND
                        belnr IN s_belnr AND
                        tcode IN s_tcode ORDER BY PRIMARY KEY.
...
* NEW CODE
          ...
          UP TO 1 ROWS 
            INTO t_reg_salida-stcd1 "Rut proveedor
            FROM lfa1
            WHERE lifnr = t_reg_salida-lifnr ORDER BY PRIMARY KEY.
...
* NEW CODE
          ...
          INTO t_reg_salida-stcd2 "Rut deudor
          FROM kna1
          WHERE kunnr = t_bseg-kunnr ORDER BY PRIMARY KEY.
...
* NEW CODE
          ...
          INTO t_reg_salida-rut_tercero "Rut de terceros
          FROM lfa1
          WHERE lifnr = t_bseg-zzrut_terc ORDER BY PRIMARY KEY.
