*&---------------------------------------------------------------------*
*& Report  ZBANMEDICA_AJUSTA_BAJAS_TOTALES
*&
*&---------------------------------------------------------------------*
*&
*&
...
parameters: fil_nam1 like rlgrap-filename obligatory
            default 'C:/'.
...
SELECTION-SCREEN SKIP.
parameters: BATCH TYPE C RADIOBUTTON GROUP 66 default 'X'.

SELECTION-SCREEN SKIP.
PARAMETERS: DIREC TYPE C RADIOBUTTON GROUP 66,
...
*
  LOOP AT TABLA.
    move tabla-anln1 to b_anln1.
    move tabla-anln2 to b_anln2.

* BEGIN. 07-07-2026 - ATC - ATC-01
* OLD CODE
*    select single * from anla where bukrs = tabla-bukrs
*                              and   anln1 = b_anln1
*                              and   anln2 = b_anln2.
*
* NEW CODE
    SELECT *
    UP TO 1 ROWS  from anla where bukrs = tabla-bukrs
                              and   anln1 = b_anln1
                              and   anln2 = b_anln2 ORDER BY PRIMARY KEY.

    ENDSELECT.
* END. 07-07-2026 - ATC - ATC-01

    IF SY-SUBRC EQ 0.
      IF NOT MARCA IS INITIAL.
        concatenate tabla-deakt+6(4) tabla-deakt+3(02)
                tabla-deakt(02) into anla-deakt.
      ELSE.
        CLEAR ANLA-DEAKT.
      ENDIF.
      ...
      ENDIF.
    ELSE.
      WRITE:/ 'ACTIVO NO EXISTE' , TABLA-BUKRS, TABLA-ANLN1 ,
              TABLA-ANLN2.
    ENDIF.
  ENDLOOP.


ENDFORM.                    " AJUSTE_DIRECT
