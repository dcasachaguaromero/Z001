...
form EJECUTA_MIS.
  ...
  data: linea1 type string value 'connect brspd52204',
  ...
  if p_rbukrs-low eq 'CL01' or p_rbukrs-low eq 'CL24'.
    "Creo archivo de ejecucion carga
    clear it_salida.
    clear path.
    clear linea2a.
    ...
    path = 'c:\mis\rstart.exe<cargaban.txt'.
    append path to it_salida.

    path = 'c:\mis\cargaban.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL01' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integraban.txt'.
    append path to it_salida.

    path = 'c:\mis\integraban.bat'.
  ...
  elseif p_rbukrs-low eq 'CL39' or p_rbukrs-low eq 'CL40'.
    ...
    path = 'c:\mis\rstart.exe<cargabio.txt'.
    append path to it_salida.

    path = 'c:\mis\cargabio.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL39' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integrabio.txt'.
    append path to it_salida.

    path = 'c:\mis\integrabio.bat'.
  ...
  elseif p_rbukrs-low eq 'CL05'.
    ...
    path = 'c:\mis\rstart.exe<cargabsa.txt'.
    append path to it_salida.

    path = 'c:\mis\cargabsa.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL05' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integrabsa.txt'.
    append path to it_salida.

    path = 'c:\mis\integrabsa.bat'.
  ...
  elseif p_rbukrs-low eq 'CL29' or p_rbukrs-low eq 'CL30'.
    ...
    path = 'c:\mis\rstart.exe<cargacdm.txt'.
    append path to it_salida.

    path = 'c:\mis\cargacdm.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL29' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integracdm.txt'.
    append path to it_salida.

    path = 'c:\mis\integracdm.bat'.
  ...
  elseif p_rbukrs-low eq 'CL35' or p_rbukrs-low eq 'CL36'.
    ...
    path = 'c:\mis\rstart.exe<cargacsm.txt'.
    append path to it_salida.

    path = 'c:\mis\cargacsm.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL35' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integracsm.txt'.
    append path to it_salida.

    path = 'c:\mis\integracsm.bat'.
  ...
  elseif p_rbukrs-low eq 'CL17' or p_rbukrs-low eq 'CL13' or p_rbukrs-low eq 'CL15'.
    ...
    path = 'c:\mis\rstart.exe<cargadav.txt'.
    append path to it_salida.

    path = 'c:\mis\cargadav.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL17' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integradav.txt'.
    append path to it_salida.

    path = 'c:\mis\integradav.bat'.
  ...
  elseif p_rbukrs-low eq 'CL06' or p_rbukrs-low eq 'CL51' or p_rbukrs-low eq 'CL57'.
    ...
    path = 'c:\mis\rstart.exe<cargahel.txt'.
    append path to it_salida.

    path = 'c:\mis\cargahel.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL51' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integrahel.txt'.
    append path to it_salida.

    path = 'c:\mis\integrahel.bat'.
  ...
  elseif p_rbukrs-low eq 'CL02'.
    ...
    path = 'c:\mis\rstart.exe<cargahom.txt'.
    append path to it_salida.

    path = 'c:\mis\cargahom.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL02' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integrahom.txt'.
    append path to it_salida.

    path = 'c:\mis\integrahom.bat'.
  ...
  elseif p_rbukrs-low eq 'CL07' or p_rbukrs-low eq 'CL08' or p_rbukrs-low eq 'CL14' or p_rbukrs-low eq 'CL32' or p_rbukrs-low eq 'CL33'.
    ...
    path = 'c:\mis\rstart.exe<cargainm.txt'.
    append path to it_salida.

    path = 'c:\mis\cargainm.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL07' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integrainm.txt'.
    append path to it_salida.

    path = 'c:\mis\integrainm.bat'.
  ...
  elseif p_rbukrs-low eq 'CL34'.
    ...
    path = 'c:\mis\rstart.exe<cargav3i.txt'.
    append path to it_salida.

    path = 'c:\mis\cargav3i.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL34' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integrav3i.txt'.
    append path to it_salida.

    path = 'c:\mis\integrav3i.bat'.
  ...
  elseif p_rbukrs-low eq 'CL27' or p_rbukrs-low eq 'CL28'.
    ...
    path = 'c:\mis\rstart.exe<cargaves.txt'.
    append path to it_salida.

    path = 'c:\mis\cargaves.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL27' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integraves.txt'.
    append path to it_salida.

    path = 'c:\mis\integraves.bat'.
  ...
  elseif p_rbukrs-low eq 'CL12' or p_rbukrs-low eq 'CL16' or p_rbukrs-low eq 'CL52' or p_rbukrs-low eq 'CL65'.
    ...
    path = 'c:\mis\rstart.exe<cargavin.txt'.
    append path to it_salida.

    path = 'c:\mis\cargavin.bat'.

    perform crea_archivo using path.

    "Ejecuta carga MIS.
    perform ejecuta_carga using 'CL52' fecha_proceso path.
    ...
    path = 'c:\mis\rstart.exe<integravin.txt'.
    append path to it_salida.

    path = 'c:\mis\integravin.bat'.
