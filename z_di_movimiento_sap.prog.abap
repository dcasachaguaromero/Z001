...
REPORT Z_DI_MOVIMIENTO_SAP message-id 26 line-size 255
...
CONSTANTS C_DF_VK(40) VALUE '224'.
...
ALTMP12 = BSEG-PSWBT.
ALTMP13 = BSEG-SGTXT.
 move ALTMP1 to ITAB3-BLART.
 move ALTMP2 to ITAB3-XREF2_HD.
 move ALTMP3 to ITAB3-USNAM.
 move ALTMP4 to ITAB3-BKTXT.
 move ALTMP5 to ITAB3-BUKRS.
 move ALTMP6 to ITAB3-BELNR.
 move ALTMP7 to ITAB3-GJAHR.
 move ALTMP8 to ITAB3-BUZEI.
 move ALTMP9 to ITAB3-KOART.
 move ALTMP10 to ITAB3-HKONT.
 move ALTMP11 to ITAB3-SHKZG.
 move ALTMP12 to ITAB3-PSWBT.
 move ALTMP13 to ITAB3-SGTXT.
 move ALTMP14 to ITAB3-BUDAT.
 move ALTMP15 to ITAB3-CPUDT.
 append ITAB3.
 cntbuf = cntbuf + 1.
 if download = 'N'.
  if cntbuf > 5000.
