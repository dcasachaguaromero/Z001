...
* NEW CODE
  SELECT periv
  UP TO 1 ROWS  FROM t001 INTO f_periv
                WHERE bukrs EQ bukrs-low ORDER BY PRIMARY KEY.         

  ENDSELECT.
* END. 07-07-2026 - ATC - ATC-01" get period variant
* BEGIN. 07-07-2026 - ATC - ATC-01
* OLD CODE
...
* NEW CODE
  SELECT abgja
  UP TO 1 ROWS  FROM t093b INTO l_abgja
                WHERE bukrs EQ bukrs-low
                  AND afabe EQ bereich1 ORDER BY PRIMARY KEY.          

  ENDSELECT.
* END. 07-07-2026 - ATC - ATC-01" get closed f.yr.
...
* NEW CODE
  SELECT afapl
  UP TO 1 ROWS  FROM t093c INTO l_afapl
                WHERE bukrs EQ bukrs-low ORDER BY PRIMARY KEY.        

  ENDSELECT.
* END. 07-07-2026 - ATC - ATC-01" get chart of acc.
...
* NEW CODE
  SELECT belnr
  UP TO 1 ROWS  FROM bkpf INTO lf_belnr
          WHERE awkey EQ in_awk
            AND awtyp EQ gt_outtab-awtyp ORDER BY PRIMARY KEY.
