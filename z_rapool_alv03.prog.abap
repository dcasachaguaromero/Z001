...
* NEW CODE
 ...
 FROM ANLE
      ...
      AND   ANLN2 EQ F_ANEPV-ANLN2
      AND   GJAHR EQ F_ANEPV-GJAHR
      AND   LNRAN EQ F_ANEPV-LNRAN ORDER BY PRIMARY KEY.
...
* NEW CODE
        SELECT *
        UP TO 1 ROWS  FROM COKEY
          WHERE HRKFT EQ ANLE-HRKFT ORDER BY PRIMARY KEY.
...
* NEW CODE
          SELECT *
          UP TO 1 ROWS  FROM ANEK
            WHERE BUKRS EQ XANEP-BUKRS
            AND   ANLN1 EQ XANEP-ANLN1
            AND   ANLN2 EQ XANEP-ANLN2
            AND   GJAHR EQ XANEP-GJAHR
            AND   LNRAN EQ XANEP-LNRAN ORDER BY PRIMARY KEY.
...
* NEW CODE
    SELECT *
 FROM AUAK
      WHERE OBJNR EQ L_OBJNR ORDER BY PRIMARY KEY.
...
* NEW CODE
        ...
        UP TO 1 ROWS  FROM ANEP
          ...
          AND   AFABE EQ AUAS-KEY01+32(2)
          AND   ZUJHR EQ AUAS-KEY01+34(4)
          AND   ZUCOD EQ AUAS-KEY01+38(4) ORDER BY PRIMARY KEY.
...
* NEW CODE
        ...
        UP TO 1 ROWS  FROM ANEK
          ...
          AND   ANLN2 EQ ANEP-ANLN2
          AND   GJAHR EQ ANEP-GJAHR
          AND   LNRAN EQ ANEP-LNRAN ORDER BY PRIMARY KEY.
