...
* NEW CODE
 SELECT erdat
 UP TO 1 ROWS    into x_erdat  " t_salida2-serdat "  ernam   name1  name2  stcd1
   FROM  lfa1
 where lfa1~LIFNR EQ t_salida2-LIFNR ORDER BY PRIMARY KEY.
...
* NEW CODE
SELECT ernam
UP TO 1 ROWS   into  x_ernam " t_salida2-serdat "  ernam   name1  name2  stcd1
   FROM  lfa1
 where lfa1~LIFNR EQ t_salida2-LIFNR ORDER BY PRIMARY KEY.
