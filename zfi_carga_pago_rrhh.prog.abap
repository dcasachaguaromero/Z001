...
*
* NEW CODE
      SELECT hkont kostl hbkid zterm sgtxt zz_agencia zzmot_emis
                    zzdesc_est zuonr zrutacreedor zzrut_terc ZLSCH
      UP TO 1 ROWS 
             INTO  (wa_lg_saknr,  wa_lg_kostl,   wa_lg_hbkid,  wa_lg_zterm,
                    wa_lg_sgtxt,  wa_lg_agencia, wa_lg_motemi, wa_lg_desc_est,
             ...
             WHERE bukrs         = wa_header-comp_code            AND
                   zcod_planilla = lg_reg_entrada-cod_proceso     AND
                   zconcepto     = lg_reg_entrada-codigo_concepto AND
                   sentido       = 'H' ORDER BY PRIMARY KEY.
...
* NEW CODE
        ...
        UP TO 1 ROWS  INTO lt_mitkz
                   FROM  skb1
                   WHERE bukrs = wa_header-comp_code AND
                         saknr = wa_lg_saknr ORDER BY PRIMARY KEY.
...
* NEW CODE
                 ...
                 UP TO 1 ROWS 
                     ...
                     FROM  lfb1
                     WHERE bukrs = wa_header-comp_code AND
                           lifnr = lg_cod_lifnr ORDER BY PRIMARY KEY.
...
* NEW CODE
                 ...
                 UP TO 1 ROWS 
                     ...
                     FROM  knb1
                     WHERE bukrs = wa_header-comp_code AND
                           kunnr = lg_cod_kunnr ORDER BY PRIMARY KEY.
...
* NEW CODE
         ...
         UP TO 1 ROWS 
                ...
                WHERE bukrs         = wa_header-comp_code            AND
                      zcod_planilla = lg_reg_entrada-cod_proceso     AND
                      zconcepto     = lg_reg_entrada-codigo_concepto AND
                      sentido       = 'D' ORDER BY PRIMARY KEY.
...
* NEW CODE
  ...
  UP TO 1 ROWS 
                ...
                WHERE bukrs EQ wa_nom_arch+4(4)  and
                      blart EQ 'RH'              and
                      bktxt EQ wa_nom_arch+0(25) and
                      STBLG EQ '0' ORDER BY PRIMARY KEY.
