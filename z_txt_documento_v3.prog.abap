...
SELECT BUKRS BELNR GJAHR BUZEI KUNNR FROM BSEG
...
* NEW CODE
  ...
  UP TO 1 ROWS  INTO W_SGTXT
      FROM KNA1
      WHERE KUNNR = IT_BSEG-KUNNR ORDER BY PRIMARY KEY.
